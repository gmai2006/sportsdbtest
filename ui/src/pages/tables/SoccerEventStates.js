...
const columns = [
  ...
  { name: 'minutesElapsed', header: 'minutesElapsed', defaultFlex: 1 },
  { name: 'periodMinuteElapsed', header: 'periodMinuteElapsed', defaultFlex: 1 },
  { name: 'context', header: 'context', defaultFlex: 1 },
]

const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'soccereventstates/selectAll',{
    headers : {
...
export default SoccerEventStates;