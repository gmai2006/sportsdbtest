...
const columns = [
  ...
  { name: 'line', header: 'line', defaultFlex: 1 },
  { name: 'lineOpening', header: 'lineOpening', defaultFlex: 1 },
  { name: 'prediction', header: 'prediction', defaultFlex: 1 },
]

const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'wageringmoneylines/selectAll',{
    headers : {
...
export default WageringMoneylines;