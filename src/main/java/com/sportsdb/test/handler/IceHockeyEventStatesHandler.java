...
// @Stateless
@Named("IceHockeyEventStatesHandler")
public class IceHockeyEventStatesHandler extends DelimiterFileHandler<IceHockeyEventStates> {

  @Inject
  @Named("DefaultJpaDao")
  public IceHockeyEventStatesHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected IceHockeyEventStates parseLine(List<String> headers, List<String> tokens) {
    IceHockeyEventStates record = new IceHockeyEventStates();
