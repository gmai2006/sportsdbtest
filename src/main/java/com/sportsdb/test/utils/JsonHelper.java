...
public class JsonHelper {
   ...
   */
  public static AmericanFootballActionPlays fromJson2AmericanFootballActionPlays(JsonElement json) {
    Objects.requireNonNull(json);
   ...
   */
  public static AmericanFootballEventStates fromJson2AmericanFootballEventStates(JsonElement json) {
    Objects.requireNonNull(json);
   ...
   */
  public static BaseballActionSubstitutions fromJson2BaseballActionSubstitutions(JsonElement json) {
    Objects.requireNonNull(json);
   ...
   */
  public static IceHockeyActionParticipants fromJson2IceHockeyActionParticipants(JsonElement json) {
    Objects.requireNonNull(json);
   ...
   */
  public static WageringStraightSpreadLines fromJson2WageringStraightSpreadLines(JsonElement json) {
    Objects.requireNonNull(json);
