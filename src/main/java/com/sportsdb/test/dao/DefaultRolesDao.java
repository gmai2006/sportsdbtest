...
public class DefaultRolesDao implements RolesDao {
    ...
    @Inject
    @Named("DefaultJpaDao")
    public DefaultRolesDao(JpaDao dao) {
        this.dao = dao;
    }
    ...
    /** {@inheritDoc} */
    @Override
    public List<Roles> select(int max) {
        return dao.select("select a from Roles a", Roles.class, max);
    }
