...
public class DefaultLocationsDao implements LocationsDao {
    ...
    @Inject
    @Named("DefaultJpaDao")
    public DefaultLocationsDao(JpaDao dao) {
        this.dao = dao;
    }

    public DefaultLocationsDao() {}
    ...
    /** {@inheritDoc} */
    @Override
    public List<Locations> select(int max) {
        return dao.select("select a from Locations a", Locations.class, max);
    }

    /** {@inheritDoc} */
    @Override
    public List<Locations> selectAll() {
        return dao.selectAll("select a from Locations a", Locations.class);
    }
