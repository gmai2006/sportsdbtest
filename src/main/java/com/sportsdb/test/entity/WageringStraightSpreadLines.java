...
public class WageringStraightSpreadLines implements Serializable {
    private static final long serialVersionUID = 163445241941767018L;
    ...
    /** Description: line_value. */
    @Basic
    @Column(name = "line_value", length = 100)
    private java.lang.String lineValue;
    /** Description: line_value_opening. */
    @Basic
    @Column(name = "line_value_opening", length = 100)
    private java.lang.String lineValueOpening;
    /** Description: prediction. */
    @Basic
    @Column(name = "prediction", length = 100)
    private java.lang.String prediction;

    public WageringStraightSpreadLines() {}
    ...
    public java.lang.String getLineValueOpening() {
        return this.lineValueOpening;
    }
    ...
    public void setLineValueOpening(java.lang.String lineValueOpening) {
        this.lineValueOpening = lineValueOpening;
    }
