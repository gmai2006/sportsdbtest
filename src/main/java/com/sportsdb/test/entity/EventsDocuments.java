...
@Entity
@Table(name = "events_documents")
public class EventsDocuments implements Serializable {
  private static final long serialVersionUID = 166867004234863790L;
