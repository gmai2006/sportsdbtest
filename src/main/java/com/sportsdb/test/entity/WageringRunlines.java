...
@Entity
@Table(name = "wagering_runlines")
public class WageringRunlines implements Serializable {
  private static final long serialVersionUID = 166867004262214328L;
