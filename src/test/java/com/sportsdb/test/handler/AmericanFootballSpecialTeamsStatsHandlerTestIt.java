...
import com.sportsdb.test.dao.DefaultAmericanFootballSpecialTeamsStatsDao;
...
public class AmericanFootballSpecialTeamsStatsHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/AmericanFootballSpecialTeamsStats.csv");
    ...
    assertEquals(
        "expect equals puntsTotal ", this.records[0].getPuntsTotal(), testResult.getPuntsTotal());
    assertEquals(
