...
public class LocationsHandlerTestIt {
    static final String inputFile = "Locations.json";
    static LocationsHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        Locations testResult = jpa.find(Locations.class, records[0].getId());
        assertEquals(
