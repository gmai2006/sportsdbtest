...
import com.sportsdb.test.dao.DefaultAddressesDao;
...
public class AddressesHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/Addresses.csv");
    ...
    assertEquals(
        "expect equals postalCode ", this.records[0].getPostalCode(), testResult.getPostalCode());
