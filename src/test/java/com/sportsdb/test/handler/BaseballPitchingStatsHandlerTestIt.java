...
public class BaseballPitchingStatsHandlerTestIt {
    ...
    public void testSelect() throws IOException {
        ...
        BaseballPitchingStats testResult =
                jpa.find(BaseballPitchingStats.class, records[0].getId());
        ...
        org.junit.Assert.assertEquals(
                ...
                this.records[0].getEarnedRuns(),
                testResult.getEarnedRuns());
        org.junit.Assert.assertEquals(
