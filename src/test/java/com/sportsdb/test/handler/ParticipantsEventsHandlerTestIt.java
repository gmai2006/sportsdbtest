...
import com.sportsdb.test.dao.DefaultParticipantsEventsDao;
...
public class ParticipantsEventsHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/ParticipantsEvents.csv");
    ...
    assertEquals(
        "expect equals alignment ", this.records[0].getAlignment(), testResult.getAlignment());
