...
import com.sportsdb.test.dao.DefaultBaseballOffensiveStatsDao;
...
public class BaseballOffensiveStatsHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/BaseballOffensiveStats.csv");
    final InputStream inputStream = new BufferedInputStream(new FileInputStream(tempFile));
    int count = handler.process(inputStream);
    String json = FileUtils.readFileFromResource2String(inputFile, Charset.defaultCharset());
    records = gson.fromJson(json, BaseballOffensiveStats[].class);
    assertEquals("match count", count, records.length);
    BaseballOffensiveStats testResult = jpa.find(BaseballOffensiveStats.class, records[0].getId());
    ...
    org.junit.Assert.assertEquals(
        "expect equals totalBases ", this.records[0].getTotalBases(), testResult.getTotalBases());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertEquals(
        "expect equals leftOnBase ", this.records[0].getLeftOnBase(), testResult.getLeftOnBase());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertEquals(
        "expect equals grandSlams ", this.records[0].getGrandSlams(), testResult.getGrandSlams());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertEquals(
        "expect equals hitByPitch ", this.records[0].getHitByPitch(), testResult.getHitByPitch());
    org.junit.Assert.assertEquals(
