...
import com.sportsdb.test.dao.DefaultBaseballEventStatesDao;
...
public class BaseballEventStatesHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/BaseballEventStates.csv");
    ...
    assertEquals(
        "expect equals inningHalf ", this.records[0].getInningHalf(), testResult.getInningHalf());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertEquals(
        "expect equals pitcherId ", this.records[0].getPitcherId(), testResult.getPitcherId());
    org.junit.Assert.assertEquals(
        "expect equals batterId ", this.records[0].getBatterId(), testResult.getBatterId());
    assertEquals(
        "expect equals batterSide ", this.records[0].getBatterSide(), testResult.getBatterSide());
