...
public class InjuryPhasesHandlerTestIt {
    ...
    public void testSelect() throws IOException {
        ...
        assertEquals(
                ...
                this.records[0].getInjuryType(),
                testResult.getInjuryType());
        assertEquals(
        ...
        assertEquals(
                ...
                this.records[0].getPhaseType(),
                testResult.getPhaseType());
        assertEquals(
                "expect equals injurySide ",
                this.records[0].getInjurySide(),
                testResult.getInjurySide());
