...
public class PersonsHandlerTestIt {
    ...
    public void testSelect() throws IOException {
        ...
        assertEquals(
                ...
                this.records[0].getPersonKey(),
                testResult.getPersonKey());
        ...
        assertEquals(
                ...
                this.records[0].getBirthDate(),
                testResult.getBirthDate());
        assertEquals(
                "expect equals deathDate ",
                this.records[0].getDeathDate(),
                testResult.getDeathDate());
        org.junit.Assert.assertEquals(
