...
public class BaseballPitchingStatsServiceTest {
  ...
  public void testFind_success() {
    ...
    org.junit.Assert.assertTrue(
        "expect equals runsAllowed ", records[0].getRunsAllowed() == testResult.getRunsAllowed());
    org.junit.Assert.assertTrue(
    ...
    org.junit.Assert.assertTrue(
        "expect equals earnedRuns ", records[0].getEarnedRuns() == testResult.getEarnedRuns());
    org.junit.Assert.assertTrue(
    ...
    org.junit.Assert.assertTrue("expect equals era ", records[0].getEra() == testResult.getEra());
    org.junit.Assert.assertTrue(
    ...
    org.junit.Assert.assertEquals(
        "expect equals eventCredit ", records[0].getEventCredit(), testResult.getEventCredit());
    org.junit.Assert.assertEquals(
        "expect equals saveCredit ", records[0].getSaveCredit(), testResult.getSaveCredit());
  }
}
