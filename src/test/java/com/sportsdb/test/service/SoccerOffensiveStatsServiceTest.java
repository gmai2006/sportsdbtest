...
public class SoccerOffensiveStatsServiceTest {
  ...
  public void testFind_success() {
    ...
    org.junit.Assert.assertEquals(
        "expect equals goalsTotal ", records[0].getGoalsTotal(), testResult.getGoalsTotal());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertEquals(
        "expect equals shotsTotal ", records[0].getShotsTotal(), testResult.getShotsTotal());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertEquals(
        "expect equals cornerKicks ", records[0].getCornerKicks(), testResult.getCornerKicks());
    org.junit.Assert.assertEquals(
