...
public class MotorRacingRaceStatsServiceTest {
  ...
  public void testFind_success() {
    ...
    org.junit.Assert.assertEquals(
        "expect equals pointsRookie ", records[0].getPointsRookie(), testResult.getPointsRookie());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertEquals(
        "expect equals speedAverage ", records[0].getSpeedAverage(), testResult.getSpeedAverage());
    org.junit.Assert.assertEquals(
        "expect equals speedUnits ", records[0].getSpeedUnits(), testResult.getSpeedUnits());
    org.junit.Assert.assertEquals(
        "expect equals status ", records[0].getStatus(), testResult.getStatus());
    org.junit.Assert.assertEquals(
        "expect equals finishesTop5 ", records[0].getFinishesTop5(), testResult.getFinishesTop5());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertEquals(
        "expect equals nonFinishes ", records[0].getNonFinishes(), testResult.getNonFinishes());
    org.junit.Assert.assertEquals(
        "expect equals wins ", records[0].getWins(), testResult.getWins());
    org.junit.Assert.assertEquals(
        "expect equals racesLeading ", records[0].getRacesLeading(), testResult.getRacesLeading());
    org.junit.Assert.assertEquals(
        "expect equals money ", records[0].getMoney(), testResult.getMoney());
    org.junit.Assert.assertEquals(
        "expect equals moneyUnits ", records[0].getMoneyUnits(), testResult.getMoneyUnits());
    org.junit.Assert.assertEquals(
        "expect equals leadsTotal ", records[0].getLeadsTotal(), testResult.getLeadsTotal());
  }
}
