...
public class WageringStraightSpreadLinesServiceTest {
  private static DefaultWageringStraightSpreadLinesService serviceMock;
  private static WageringStraightSpreadLines[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultWageringStraightSpreadLinesService.class);
    String inputFile = "WageringStraightSpreadLines.json";
    try {
  ...
  public void testFind_success() {
    WageringStraightSpreadLines testResult = serviceMock.find(records[0].getId());
