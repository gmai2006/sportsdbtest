...
public class OutcomeTotalsServiceTest {
  ...
  public void testFind_success() {
    ...
    org.junit.Assert.assertEquals(
        "expect equals undecideds ", records[0].getUndecideds(), testResult.getUndecideds());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertEquals(
        "expect equals streakType ", records[0].getStreakType(), testResult.getStreakType());
    org.junit.Assert.assertEquals(
        "expect equals streakDuration ",
        records[0].getStreakDuration(),
        testResult.getStreakDuration());
    org.junit.Assert.assertEquals(
        "expect equals streakTotal ", records[0].getStreakTotal(), testResult.getStreakTotal());
  }
}
