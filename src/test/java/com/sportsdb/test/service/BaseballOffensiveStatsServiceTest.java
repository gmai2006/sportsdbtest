...
public class BaseballOffensiveStatsServiceTest {
    ...
    public void testFind_success() {
        ...
        org.junit.Assert.assertTrue(
                ...
                records[0].getRunsScored() == testResult.getRunsScored());
        org.junit.Assert.assertTrue(
                "expect equals atBats ", records[0].getAtBats() == testResult.getAtBats());
        org.junit.Assert.assertTrue(
                "expect equals hits ", records[0].getHits() == testResult.getHits());
        org.junit.Assert.assertTrue(
                "expect equals rbi ", records[0].getRbi() == testResult.getRbi());
        org.junit.Assert.assertTrue(
                "expect equals totalBases ",
                records[0].getTotalBases() == testResult.getTotalBases());
        org.junit.Assert.assertTrue(
        ...
        org.junit.Assert.assertTrue(
                ...
                records[0].getLeftOnBase() == testResult.getLeftOnBase());
        org.junit.Assert.assertTrue(
        ...
        org.junit.Assert.assertTrue(
                ...
                records[0].getGrandSlams() == testResult.getGrandSlams());
        org.junit.Assert.assertTrue(
        ...
        org.junit.Assert.assertTrue(
                ...
                records[0].getPlateAppearancesPerHomeRun()
        ...
        org.junit.Assert.assertTrue(
                ...
                records[0].getStolenBases() == testResult.getStolenBases());
        org.junit.Assert.assertTrue(
        ...
        org.junit.Assert.assertTrue(
                ...
                records[0].getHitByPitch() == testResult.getHitByPitch());
        org.junit.Assert.assertTrue(
