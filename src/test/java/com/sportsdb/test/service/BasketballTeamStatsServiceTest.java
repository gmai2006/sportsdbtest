...
public class BasketballTeamStatsServiceTest {
  ...
  public void testFind_success() {
    ...
    org.junit.Assert.assertEquals(
        "expect equals timeoutsLeft ", records[0].getTimeoutsLeft(), testResult.getTimeoutsLeft());
    org.junit.Assert.assertEquals(
        "expect equals largestLead ", records[0].getLargestLead(), testResult.getLargestLead());
    org.junit.Assert.assertEquals(
        "expect equals foulsTotal ", records[0].getFoulsTotal(), testResult.getFoulsTotal());
    org.junit.Assert.assertEquals(
