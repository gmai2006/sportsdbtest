...
public class BaseballEventStatesServiceTest {
  ...
  public void testFind_success() {
    ...
    org.junit.Assert.assertTrue(
        "expect equals atBatNumber ", records[0].getAtBatNumber() == testResult.getAtBatNumber());
    org.junit.Assert.assertTrue(
        "expect equals inningValue ", records[0].getInningValue() == testResult.getInningValue());
    org.junit.Assert.assertEquals(
        "expect equals inningHalf ", records[0].getInningHalf(), testResult.getInningHalf());
    org.junit.Assert.assertTrue(
    ...
    org.junit.Assert.assertEquals(
        "expect equals batterSide ", records[0].getBatterSide(), testResult.getBatterSide());
    org.junit.Assert.assertEquals(
