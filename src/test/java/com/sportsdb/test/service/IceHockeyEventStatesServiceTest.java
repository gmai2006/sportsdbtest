...
public class IceHockeyEventStatesServiceTest {
  private static DefaultIceHockeyEventStatesService serviceMock;
  private static IceHockeyEventStates[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultIceHockeyEventStatesService.class);
    String inputFile = "IceHockeyEventStates.json";
    try {
  ...
  public void testFind_success() {
    IceHockeyEventStates testResult = serviceMock.find(records[0].getId());
