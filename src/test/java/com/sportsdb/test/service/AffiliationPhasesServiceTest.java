...
public class AffiliationPhasesServiceTest {
  private static DefaultAffiliationPhasesService serviceMock;
  private static AffiliationPhases[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultAffiliationPhasesService.class);
    String inputFile = "AffiliationPhases.json";
    try {
  ...
  public void testFind_success() {
    AffiliationPhases testResult = serviceMock.find(records[0].getId());
    ...
    org.junit.Assert.assertTrue(
        ...
        records[0].getAncestorAffiliationId() == testResult.getAncestorAffiliationId());
    org.junit.Assert.assertTrue(
