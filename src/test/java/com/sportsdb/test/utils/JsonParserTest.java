...
public class JsonParserTest {
    ...
    public void testParsingAddresses() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals id ", o.get("id").getAsInt(), result.get(i).getId(), 0.0001);
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals language ",
                    o.get("language").getAsString(),
                    result.get(i).getLanguage());
            assertEquals(
                    "expect equals suite ", o.get("suite").getAsString(), result.get(i).getSuite());
            assertEquals(
                    "expect equals floor ", o.get("floor").getAsString(), result.get(i).getFloor());
            assertEquals(
                    "expect equals building ",
                    o.get("building").getAsString(),
                    result.get(i).getBuilding());
            assertEquals(
            ...
            assertEquals(
                    "expect equals street ",
                    o.get("street").getAsString(),
                    result.get(i).getStreet());
            assertEquals(
            ...
            assertEquals(
                    "expect equals district ",
                    o.get("district").getAsString(),
                    result.get(i).getDistrict());
            assertEquals(
                    "expect equals locality ",
                    o.get("locality").getAsString(),
                    result.get(i).getLocality());
            assertEquals(
                    "expect equals county ",
                    o.get("county").getAsString(),
                    result.get(i).getCounty());
            assertEquals(
                    "expect equals region ",
                    o.get("region").getAsString(),
                    result.get(i).getRegion());
            assertEquals(
                    "expect equals postalCode ",
                    o.get("postalCode").getAsString(),
                    result.get(i).getPostalCode());
            assertEquals(
                    "expect equals country ",
                    o.get("country").getAsString(),
    ...
    public void testParsingAmericanFootballActionPlays() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals playType ",
                    o.get("playType").getAsString(),
                    result.get(i).getPlayType());
            assertEquals(
    ...
    public void testParsingAmericanFootballEventStates() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals context ",
                    o.get("context").getAsString(),
                    result.get(i).getContext());
        }
    ...
    public void testParsingBaseballActionContactDetails() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals strength ",
                    o.get("strength").getAsString(),
                    result.get(i).getStrength());
            assertEquals(
    ...
    public void testParsingBaseballActionPitches() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    result.get(i).getTrajectoryFormula());
            assertEquals(
                    "expect equals ballType ",
                    o.get("ballType").getAsString(),
                    result.get(i).getBallType());
            assertEquals(
    ...
    public void testParsingBaseballActionPlays() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    result.get(i).getPlayType());
            assertEquals(
                    "expect equals notation ",
                    o.get("notation").getAsString(),
                    result.get(i).getNotation());
            assertEquals(
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals rbi ", o.get("rbi").getAsInt(), result.get(i).getRbi(), 0.0001);
            assertEquals(
    ...
    public void testParsingBaseballDefensiveStats() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals errors ",
                    o.get("errors").getAsInt(),
    ...
    public void testParsingBaseballEventStates() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals outs ",
                    o.get("outs").getAsInt(),
                    result.get(i).getOuts(),
                    0.0001);
            assertEquals(
                    "expect equals balls ",
                    o.get("balls").getAsInt(),
                    result.get(i).getBalls(),
                    0.0001);
            assertEquals(
    ...
    public void testParsingBaseballOffensiveStats() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals atBats ",
                    o.get("atBats").getAsInt(),
                    result.get(i).getAtBats(),
                    0.0001);
            assertEquals(
                    "expect equals hits ",
                    o.get("hits").getAsInt(),
                    result.get(i).getHits(),
                    0.0001);
            assertEquals(
                    "expect equals rbi ", o.get("rbi").getAsInt(), result.get(i).getRbi(), 0.0001);
            assertEquals(
    ...
    public void testParsingBaseballPitchingStats() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals era ", o.get("era").getAsFloat(), result.get(i).getEra(), 0.001);
            assertEquals(
            ...
            assertEquals(
                    "expect equals balks ",
                    o.get("balks").getAsInt(),
                    result.get(i).getBalks(),
                    0.0001);
            assertEquals(
                    "expect equals wins ",
                    o.get("wins").getAsInt(),
                    result.get(i).getWins(),
                    0.0001);
            assertEquals(
                    "expect equals losses ",
                    o.get("losses").getAsInt(),
                    result.get(i).getLosses(),
                    0.0001);
            assertEquals(
                    "expect equals saves ",
                    o.get("saves").getAsInt(),
                    result.get(i).getSaves(),
                    0.0001);
            assertEquals(
    ...
    public void testParsingCoreStats() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals id ", o.get("id").getAsInt(), result.get(i).getId(), 0.0001);
            assertEquals(
                    "expect equals score ", o.get("score").getAsString(), result.get(i).getScore());
            assertEquals(
    ...
    public void testParsingDisplayNames() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals alias ", o.get("alias").getAsString(), result.get(i).getAlias());
            assertEquals(
            ...
            assertEquals(
                    ...
                    o.get("prefix").getAsString(),
                    result.get(i).getPrefix());
            assertEquals(
                    "expect equals suffix ",
                    o.get("suffix").getAsString(),
                    result.get(i).getSuffix());
        }
    ...
    public void testParsingDocumentContents() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals sportsml ",
                    o.get("sportsml").getAsString(),
                    result.get(i).getSportsml());
            assertEquals(
    ...
    public void testParsingDocumentPackageEntry() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals rank ", o.get("rank").getAsString(), result.get(i).getRank());
            assertEquals(
                    "expect equals documentId ",
                    o.get("documentId").getAsInt(),
                    result.get(i).getDocumentId(),
                    0.0001);
            assertEquals(
                    "expect equals headline ",
                    o.get("headline").getAsString(),
                    result.get(i).getHeadline());
            assertEquals(
    ...
    public void testParsingDocuments() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals id ", o.get("id").getAsInt(), result.get(i).getId(), 0.0001);
            assertEquals(
                    "expect equals docId ", o.get("docId").getAsString(), result.get(i).getDocId());
            assertEquals(
                    "expect equals publisherId ",
                    o.get("publisherId").getAsInt(),
                    result.get(i).getPublisherId(),
    ...
    public void testParsingEvents() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals id ", o.get("id").getAsInt(), result.get(i).getId(), 0.0001);
            assertEquals(
                    "expect equals eventKey ",
                    o.get("eventKey").getAsString(),
                    result.get(i).getEventKey());
            assertEquals(
                    "expect equals publisherId ",
                    o.get("publisherId").getAsInt(),
                    result.get(i).getPublisherId(),
                    0.0001);
            assertEquals(
                    "expect equals siteId ",
                    o.get("siteId").getAsInt(),
                    result.get(i).getSiteId(),
                    0.0001);
            assertEquals(
    ...
    public void testParsingIceHockeyDefensiveStats() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals saves ", o.get("saves").getAsString(), result.get(i).getSaves());
            assertEquals(
            ...
            assertEquals(
                    "expect equals hits ", o.get("hits").getAsString(), result.get(i).getHits());
            assertEquals(
    ...
    public void testParsingIceHockeyOffensiveStats() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals assists ",
                    o.get("assists").getAsString(),
                    result.get(i).getAssists());
            assertEquals(
                    "expect equals points ",
                    o.get("points").getAsString(),
                    result.get(i).getPoints());
            assertEquals(
    ...
    public void testParsingKeyAliases() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals keyId ",
                    o.get("keyId").getAsInt(),
                    result.get(i).getKeyId(),
                    0.0001);
            assertEquals(
    ...
    public void testParsingKeyRoots() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals id ", o.get("id").getAsInt(), result.get(i).getId(), 0.0001);
            assertEquals(
                    "expect equals keyType ",
                    o.get("keyType").getAsString(),
                    result.get(i).getKeyType());
        }
    ...
    public void testParsingLocations() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals id ", o.get("id").getAsInt(), result.get(i).getId(), 0.0001);
            assertEquals(
                    "expect equals timezone ",
                    o.get("timezone").getAsString(),
                    result.get(i).getTimezone());
            assertEquals(
                    "expect equals latitude ",
                    o.get("latitude").getAsString(),
    ...
    public void testParsingMedia() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals dateTime ",
                    o.get("dateTime").getAsString(),
                    result.get(i).getDateTime());
            assertEquals(
    ...
    public void testParsingMediaCaptions() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals caption ",
                    o.get("caption").getAsString(),
                    result.get(i).getCaption());
            assertEquals(
    ...
    public void testParsingMediaContents() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals object ",
                    o.get("object").getAsString(),
                    result.get(i).getObject());
            assertEquals(
                    "expect equals format ",
                    o.get("format").getAsString(),
                    result.get(i).getFormat());
            assertEquals(
                    "expect equals mimeType ",
                    o.get("mimeType").getAsString(),
                    result.get(i).getMimeType());
            assertEquals(
                    "expect equals height ",
                    o.get("height").getAsString(),
                    result.get(i).getHeight());
            assertEquals(
                    "expect equals width ", o.get("width").getAsString(), result.get(i).getWidth());
            assertEquals(
                    "expect equals duration ",
                    o.get("duration").getAsString(),
                    result.get(i).getDuration());
            assertEquals(
                    "expect equals fileSize ",
                    o.get("fileSize").getAsString(),
                    result.get(i).getFileSize());
            assertEquals(
    ...
    public void testParsingMotorRacingQualifyingStats() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals id ", o.get("id").getAsInt(), result.get(i).getId(), 0.0001);
            assertEquals(
                    "expect equals grid ", o.get("grid").getAsString(), result.get(i).getGrid());
            assertEquals(
                    "expect equals polePosition ",
                    o.get("polePosition").getAsString(),
                    result.get(i).getPolePosition());
            assertEquals(
                    "expect equals poleWins ",
                    o.get("poleWins").getAsString(),
                    result.get(i).getPoleWins());
            assertEquals(
    ...
    public void testParsingMotorRacingRaceStats() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals time ", o.get("time").getAsString(), result.get(i).getTime());
            assertEquals(
                    "expect equals points ",
                    o.get("points").getAsString(),
                    result.get(i).getPoints());
            ...
            assertEquals(
                    "expect equals bonus ", o.get("bonus").getAsString(), result.get(i).getBonus());
            assertEquals(
            ...
            assertEquals(
                    "expect equals starts ",
                    o.get("starts").getAsString(),
                    result.get(i).getStarts());
            assertEquals(
                    "expect equals finishes ",
                    o.get("finishes").getAsString(),
                    result.get(i).getFinishes());
            assertEquals(
                    "expect equals nonFinishes ",
                    o.get("nonFinishes").getAsString(),
                    result.get(i).getNonFinishes());
            assertEquals(
                    "expect equals wins ", o.get("wins").getAsString(), result.get(i).getWins());
            assertEquals(
                    "expect equals racesLeading ",
                    o.get("racesLeading").getAsString(),
                    result.get(i).getRacesLeading());
            assertEquals(
                    "expect equals money ", o.get("money").getAsString(), result.get(i).getMoney());
            assertEquals(
    ...
    public void testParsingOutcomeTotals() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals losses ",
                    o.get("losses").getAsString(),
                    result.get(i).getLosses());
            assertEquals(
                    "expect equals ties ", o.get("ties").getAsString(), result.get(i).getTies());
            assertEquals(
    ...
    public void testParsingPersonEventMetadata() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    result.get(i).getStatus());
            assertEquals(
                    "expect equals health ",
                    o.get("health").getAsString(),
                    result.get(i).getHealth());
            assertEquals(
                    "expect equals weight ",
                    o.get("weight").getAsString(),
                    result.get(i).getWeight());
            assertEquals(
                    "expect equals roleId ",
                    o.get("roleId").getAsInt(),
                    result.get(i).getRoleId(),
                    0.0001);
            assertEquals(
                    "expect equals positionId ",
                    o.get("positionId").getAsInt(),
                    ...
                    0.0001);
            assertEquals(
                    "expect equals teamId ",
                    o.get("teamId").getAsInt(),
                    result.get(i).getTeamId(),
                    0.0001);
            assertEquals(
    ...
    public void testParsingPersons() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals gender ",
                    o.get("gender").getAsString(),
    ...
    public void testParsingRoles() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals id ", o.get("id").getAsInt(), result.get(i).getId(), 0.0001);
            assertEquals(
                    "expect equals roleKey ",
                    o.get("roleKey").getAsString(),
                    result.get(i).getRoleKey());
            assertEquals(
                    "expect equals roleName ",
                    o.get("roleName").getAsString(),
                    result.get(i).getRoleName());
            assertEquals(
                    "expect equals comment ",
                    o.get("comment").getAsString(),
                    result.get(i).getComment());
    ...
    public void testParsingSoccerOffensiveStats() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    result.get(i).getGiveaways());
            assertEquals(
                    "expect equals offsides ",
                    o.get("offsides").getAsString(),
                    result.get(i).getOffsides());
            assertEquals(
    ...
    public void testParsingTeamAmericanFootballStats() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals timeouts ",
                    o.get("timeouts").getAsString(),
                    result.get(i).getTimeouts());
            assertEquals(
    ...
    public void testParsingTeams() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals id ", o.get("id").getAsInt(), result.get(i).getId(), 0.0001);
            assertEquals(
                    "expect equals teamKey ",
                    o.get("teamKey").getAsString(),
                    result.get(i).getTeamKey());
            assertEquals(
                    "expect equals publisherId ",
                    o.get("publisherId").getAsInt(),
                    result.get(i).getPublisherId(),
    ...
    public void testParsingTennisActionPoints() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    result.get(i).getSequenceNumber());
            assertEquals(
                    "expect equals winType ",
                    o.get("winType").getAsString(),
                    result.get(i).getWinType());
        }
    ...
    public void testParsingTennisActionVolleys() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals spinType ",
                    o.get("spinType").getAsString(),
                    result.get(i).getSpinType());
            assertEquals(
    ...
    public void testParsingTennisEventStates() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals game ", o.get("game").getAsString(), result.get(i).getGame());
            assertEquals(
    ...
    public void testParsingTennisServiceStats() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    result.get(i).getMatchesPlayed());
            assertEquals(
                    "expect equals aces ", o.get("aces").getAsString(), result.get(i).getAces());
            assertEquals(
    ...
    public void testParsingWageringMoneylines() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    result.get(i).getComment());
            assertEquals(
                    "expect equals vigorish ",
                    o.get("vigorish").getAsString(),
                    result.get(i).getVigorish());
            assertEquals(
                    "expect equals line ", o.get("line").getAsString(), result.get(i).getLine());
            assertEquals(
    ...
    public void testParsingWageringTotalScoreLines() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    result.get(i).getVigorish());
            assertEquals(
                    "expect equals lineOver ",
                    o.get("lineOver").getAsString(),
                    result.get(i).getLineOver());
            assertEquals(
                    "expect equals lineUnder ",
                    o.get("lineUnder").getAsString(),
                    result.get(i).getLineUnder());
            assertEquals(
                    "expect equals total ", o.get("total").getAsString(), result.get(i).getTotal());
            assertEquals(
    ...
    public void testParsingWeatherConditions() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals humidity ",
                    o.get("humidity").getAsString(),
                    result.get(i).getHumidity());
            assertEquals(
                    "expect equals clouds ",
                    o.get("clouds").getAsString(),
                    result.get(i).getClouds());
            assertEquals(
