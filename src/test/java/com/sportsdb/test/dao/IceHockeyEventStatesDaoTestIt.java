...
public class IceHockeyEventStatesDaoTestIt {
  static final String inputFile = "IceHockeyEventStates.json";
  static IceHockeyEventStatesDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultIceHockeyEventStatesDao(jpa);
  }
  ...
  public void testSelect() {
    IceHockeyEventStates testResult = dao.find(records[1].getId());
