...
public class SubPeriodsDaoTestIt {
  static final String inputFile = "SubPeriods.json";
  static SubPeriodsDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSubPeriodsDao(jpa);
  }
  ...
  public void testSelect() {
    SubPeriods testResult = dao.find(records[1].getId());
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertTrue(
        "expect equals periodId ", this.records[1].getPeriodId() == testResult.getPeriodId());
    org.junit.Assert.assertEquals(
        "expect equals subPeriodValue ",
        this.records[1].getSubPeriodValue(),
