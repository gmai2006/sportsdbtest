...
public class BaseballPitchingStatsDaoTestIt {
  ...
  public void testSelect() {
    ...
    org.junit.Assert.assertTrue(
        "expect equals earnedRuns ", this.records[1].getEarnedRuns() == testResult.getEarnedRuns());
    org.junit.Assert.assertTrue(
    ...
    org.junit.Assert.assertTrue(
        ...
        this.records[1].getBasesOnBallsIntentional() == testResult.getBasesOnBallsIntentional());
    org.junit.Assert.assertTrue(
    ...
    org.junit.Assert.assertTrue(
        ...
        this.records[1].getInheritedRunnersScored() == testResult.getInheritedRunnersScored());
    org.junit.Assert.assertTrue(
        "expect equals pickOffs ", this.records[1].getPickOffs() == testResult.getPickOffs());
    org.junit.Assert.assertTrue(
    ...
    org.junit.Assert.assertEquals(
        "expect equals saveCredit ", this.records[1].getSaveCredit(), testResult.getSaveCredit());
  }
}
