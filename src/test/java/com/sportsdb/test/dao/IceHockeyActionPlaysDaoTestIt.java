...
public class IceHockeyActionPlaysDaoTestIt {
  static final String inputFile = "IceHockeyActionPlays.json";
  static IceHockeyActionPlaysDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultIceHockeyActionPlaysDao(jpa);
  }
  ...
  public void testSelect() {
    IceHockeyActionPlays testResult = dao.find(records[1].getId());
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertTrue(
        "expect equals iceHockeyEventStateId ",
        this.records[1].getIceHockeyEventStateId() == testResult.getIceHockeyEventStateId());
    ...
    org.junit.Assert.assertEquals(
        "expect equals playResult ", this.records[1].getPlayResult(), testResult.getPlayResult());
    org.junit.Assert.assertEquals(
