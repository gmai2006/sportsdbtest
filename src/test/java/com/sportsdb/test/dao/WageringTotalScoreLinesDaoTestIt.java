...
public class WageringTotalScoreLinesDaoTestIt {
    static final String inputFile = "WageringTotalScoreLines.json";
    static WageringTotalScoreLinesDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultWageringTotalScoreLinesDao(jpa);
    }
    ...
    public void testSelect() {
        WageringTotalScoreLines testResult = dao.find(records[1].getId());
        ...
        org.junit.Assert.assertEquals(
                "expect equals lineOver ", this.records[1].getLineOver(), testResult.getLineOver());
        org.junit.Assert.assertEquals(
                "expect equals lineUnder ",
                this.records[1].getLineUnder(),
                testResult.getLineUnder());
        org.junit.Assert.assertEquals(
                "expect equals total ", this.records[1].getTotal(), testResult.getTotal());
        org.junit.Assert.assertEquals(
                "expect equals totalOpening ",
                this.records[1].getTotalOpening(),
