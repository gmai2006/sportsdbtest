...
public class PersonPhasesDaoTestIt {
  ...
  public void testSelect() {
    ...
    org.junit.Assert.assertEquals(
        "expect equals roleStatus ", this.records[1].getRoleStatus(), testResult.getRoleStatus());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertEquals(
        "expect equals exitReason ", this.records[1].getExitReason(), testResult.getExitReason());
    org.junit.Assert.assertTrue(
