...
public class AmericanFootballDefensiveStatsDaoTestIt {
  ...
  public void testSelect() {
    ...
    org.junit.Assert.assertEquals(
        "expect equals sacksTotal ", this.records[1].getSacksTotal(), testResult.getSacksTotal());
    org.junit.Assert.assertEquals(
        "expect equals sacksYards ", this.records[1].getSacksYards(), testResult.getSacksYards());
    org.junit.Assert.assertEquals(
