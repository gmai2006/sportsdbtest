...
public class BaseballActionContactDetailsDaoTestIt {
  static final String inputFile = "BaseballActionContactDetails.json";
  static BaseballActionContactDetailsDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultBaseballActionContactDetailsDao(jpa);
  }
  ...
  public void testSelect() {
    BaseballActionContactDetails testResult = dao.find(records[1].getId());
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertTrue(
        "expect equals baseballActionPitchId ",
        this.records[1].getBaseballActionPitchId() == testResult.getBaseballActionPitchId());
    org.junit.Assert.assertEquals(
        "expect equals location ", this.records[1].getLocation(), testResult.getLocation());
    org.junit.Assert.assertEquals(
        "expect equals strength ", this.records[1].getStrength(), testResult.getStrength());
    org.junit.Assert.assertTrue(
        "expect equals velocity ", this.records[1].getVelocity() == testResult.getVelocity());
    org.junit.Assert.assertEquals(
