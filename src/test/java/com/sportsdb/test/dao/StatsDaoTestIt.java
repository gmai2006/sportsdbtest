...
public class StatsDaoTestIt {
    ...
    public void testSelect() {
        Stats testResult = dao.find(records[1].getId());
        assertNotNull("expect result", testResult);
        org.junit.Assert.assertEquals(
                "expect equals statRepositoryType ",
                this.records[1].getStatRepositoryType(),
                testResult.getStatRepositoryType());
        org.junit.Assert.assertTrue(
                "expect equals statRepositoryId ",
                this.records[1].getStatRepositoryId() == testResult.getStatRepositoryId());
        org.junit.Assert.assertEquals(
                "expect equals statHolderType ",
                this.records[1].getStatHolderType(),
                testResult.getStatHolderType());
        org.junit.Assert.assertTrue(
                "expect equals statHolderId ",
                this.records[1].getStatHolderId() == testResult.getStatHolderId());
        org.junit.Assert.assertEquals(
                "expect equals statCoverageType ",
                this.records[1].getStatCoverageType(),
                testResult.getStatCoverageType());
        org.junit.Assert.assertTrue(
                "expect equals statCoverageId ",
                this.records[1].getStatCoverageId() == testResult.getStatCoverageId());
        org.junit.Assert.assertEquals(
