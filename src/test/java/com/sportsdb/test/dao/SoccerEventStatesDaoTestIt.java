...
public class SoccerEventStatesDaoTestIt {
  static final String inputFile = "SoccerEventStates.json";
  static SoccerEventStatesDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSoccerEventStatesDao(jpa);
  }
  ...
  public void testSelect() {
    SoccerEventStates testResult = dao.find(records[1].getId());
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[1].getMinutesElapsed(),
        testResult.getMinutesElapsed());
    org.junit.Assert.assertEquals(
        "expect equals periodMinuteElapsed ",
        this.records[1].getPeriodMinuteElapsed(),
