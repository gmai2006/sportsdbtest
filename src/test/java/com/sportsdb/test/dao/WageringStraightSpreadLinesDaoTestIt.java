...
public class WageringStraightSpreadLinesDaoTestIt {
  static final String inputFile = "WageringStraightSpreadLines.json";
  static WageringStraightSpreadLinesDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultWageringStraightSpreadLinesDao(jpa);
  }
  ...
  public void testSelect() {
    WageringStraightSpreadLines testResult = dao.find(records[1].getId());
    ...
    org.junit.Assert.assertEquals(
        "expect equals vigorish ", this.records[1].getVigorish(), testResult.getVigorish());
    org.junit.Assert.assertEquals(
        "expect equals lineValue ", this.records[1].getLineValue(), testResult.getLineValue());
    org.junit.Assert.assertEquals(
        "expect equals lineValueOpening ",
        this.records[1].getLineValueOpening(),
