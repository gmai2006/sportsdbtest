...
public class BasketballTeamStatsDaoTestIt {
  static final String inputFile = "BasketballTeamStats.json";
  static BasketballTeamStatsDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultBasketballTeamStatsDao(jpa);
  }
  ...
  public void testSelect() {
    BasketballTeamStats testResult = dao.find(records[1].getId());
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertEquals(
        "expect equals timeoutsLeft ",
        this.records[1].getTimeoutsLeft(),
        testResult.getTimeoutsLeft());
    org.junit.Assert.assertEquals(
        "expect equals largestLead ",
        this.records[1].getLargestLead(),
        testResult.getLargestLead());
    org.junit.Assert.assertEquals(
        "expect equals foulsTotal ", this.records[1].getFoulsTotal(), testResult.getFoulsTotal());
    org.junit.Assert.assertEquals(
        "expect equals turnoverMargin ",
        this.records[1].getTurnoverMargin(),
