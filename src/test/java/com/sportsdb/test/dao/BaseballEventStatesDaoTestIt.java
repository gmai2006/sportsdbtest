...
public class BaseballEventStatesDaoTestIt {
  ...
  public void testSelect() {
    ...
    org.junit.Assert.assertEquals(
        "expect equals inningHalf ", this.records[1].getInningHalf(), testResult.getInningHalf());
    org.junit.Assert.assertTrue(
    ...
    org.junit.Assert.assertTrue(
        "expect equals pitcherId ", this.records[1].getPitcherId() == testResult.getPitcherId());
    org.junit.Assert.assertTrue(
        "expect equals batterId ", this.records[1].getBatterId() == testResult.getBatterId());
    org.junit.Assert.assertEquals(
        "expect equals batterSide ", this.records[1].getBatterSide(), testResult.getBatterSide());
    org.junit.Assert.assertEquals(
