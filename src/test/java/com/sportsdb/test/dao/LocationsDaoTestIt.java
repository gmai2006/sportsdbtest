...
public class LocationsDaoTestIt {
    static final String inputFile = "Locations.json";
    static LocationsDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private Locations[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultLocationsDao(jpa);
    }
    ...
    public void testSelect() {
        Locations testResult = dao.find(records[1].getId());
        ...
        org.junit.Assert.assertEquals(
                ...
                this.records[1].getLongitude(),
                testResult.getLongitude());
        org.junit.Assert.assertEquals(
