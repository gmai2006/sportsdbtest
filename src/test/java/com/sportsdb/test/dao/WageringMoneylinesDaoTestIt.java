...
public class WageringMoneylinesDaoTestIt {
    static final String inputFile = "WageringMoneylines.json";
    static WageringMoneylinesDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private WageringMoneylines[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultWageringMoneylinesDao(jpa);
    }
    ...
    public void testSelect() {
        WageringMoneylines testResult = dao.find(records[1].getId());
        ...
        org.junit.Assert.assertEquals(
                "expect equals line ", this.records[1].getLine(), testResult.getLine());
        org.junit.Assert.assertEquals(
                "expect equals lineOpening ",
                this.records[1].getLineOpening(),
