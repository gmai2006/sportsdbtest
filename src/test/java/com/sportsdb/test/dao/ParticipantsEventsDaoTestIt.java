...
public class ParticipantsEventsDaoTestIt {
  static final String inputFile = "ParticipantsEvents.json";
  static ParticipantsEventsDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultParticipantsEventsDao(jpa);
  }
