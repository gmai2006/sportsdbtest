...
public class AmericanFootballEventStatesDaoTestIt {
  ...
  public void testSelect() {
    ...
    org.junit.Assert.assertEquals(
        "expect equals clockState ", this.records[1].getClockState(), testResult.getClockState());
    org.junit.Assert.assertTrue(
    ...
    org.junit.Assert.assertEquals(
        "expect equals fieldSide ", this.records[1].getFieldSide(), testResult.getFieldSide());
    org.junit.Assert.assertTrue(
