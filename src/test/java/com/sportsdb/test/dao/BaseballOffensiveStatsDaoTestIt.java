...
public class BaseballOffensiveStatsDaoTestIt {
    ...
    public void testSelect() {
        ...
        org.junit.Assert.assertTrue(
                ...
                this.records[1].getTotalBases() == testResult.getTotalBases());
        org.junit.Assert.assertTrue(
        ...
        org.junit.Assert.assertTrue(
                ...
                this.records[1].getLeftOnBase() == testResult.getLeftOnBase());
        org.junit.Assert.assertTrue(
                "expect equals leftInScoringPosition ",
                this.records[1].getLeftInScoringPosition()
        ...
        org.junit.Assert.assertTrue(
                ...
                this.records[1].getSacFlies() == testResult.getSacFlies());
        org.junit.Assert.assertTrue(
                "expect equals sacBunts ",
                this.records[1].getSacBunts() == testResult.getSacBunts());
        org.junit.Assert.assertTrue(
                "expect equals groundedIntoDoublePlay ",
                this.records[1].getGroundedIntoDoublePlay()
        ...
        org.junit.Assert.assertTrue(
                ...
                this.records[1].getHitByPitch() == testResult.getHitByPitch());
        org.junit.Assert.assertTrue(
