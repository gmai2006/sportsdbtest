...
public class WageringRunlinesDaoTestIt {
  static final String inputFile = "WageringRunlines.json";
  static WageringRunlinesDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultWageringRunlinesDao(jpa);
  }
  ...
  public void testSelect() {
    WageringRunlines testResult = dao.find(records[1].getId());
